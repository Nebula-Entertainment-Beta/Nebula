...
namespace Nimbus
{
  ...
  void MainCameraScript::onCreate(Nebula::ScriptContext &ctx, Nebula::Entity self)
  {
    ...
    m_lookSensitivity = Nebula::readScriptParamFloat(sc.paramsJson, "lookSensitivity", 0.0035f);
    m_zoomSpeed = Nebula::readScriptParamFloat(sc.paramsJson, "zoomSpeed", 0.6f);
    m_pitchMin = Nebula::readScriptParamFloat(sc.paramsJson, "pitchMin", -1.2f);
    m_pitchMax = Nebula::readScriptParamFloat(sc.paramsJson, "pitchMax", 0.65f);
    m_minDistance = Nebula::readScriptParamFloat(sc.paramsJson, "minDistance", 1.5f);
    m_maxDistance = Nebula::readScriptParamFloat(sc.paramsJson, "maxDistance", 24.f);
    }
